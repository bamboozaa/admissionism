        ...
        <div class="row">
            ...
            <div class="container" id="form-container">
                <div class="col-12 col-md-12">
                    <form method="post" action="enquiry_insert.php">
                        <div class="text-left py-3">
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-md-6">
                                    ...
                                    <select id="program_interested" name="program_interested" class="form-select"
                                        required>
                                    ...
                                    <option value="BA - Business English Option in the major">BA - Business English Option
                                        in the major</option>
                        ...
                        <option value="GLOBAL MBA/MPA (Australia – Two Degree Program)">GLOBAL MBA/MPA (Australia – Two Degree Program)</option>-->
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select id="entry_semester" name="entry_semester" class="form-select" required>
                                        <option value="" selected disabled hidden>Choose here</option>
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="current_education" value="" class="form-control" list="current_education" required>
                                ...
                                <div class="form-group col-md-6">
                                    <label for="school_name">SCHOOL/UNIVERSITY NAME <span
                                            class="text-danger">*</span></label>
                                    <input type="text" id="school_name" name="school_name" placeholder="" class="form-control" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="form-group col-md-6">
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" id="direct_message" name="direct_message"
                                        class="form-control" />
                                </div>
                                <div class="form-group col-md-6">
